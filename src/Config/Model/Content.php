            ...
            ->children()
                ...
                ->arrayNode('admin')
                    ...
                    ->children()
                        ...
                        ->scalarNode('list_is_granted')->end()
                        ->scalarNode('list_view')->end()
                        ->scalarNode('list_page_view')->end()
                        ->scalarNode('list_filter_form')->end()
                        ->scalarNode('create_is_granted')->end()
                        ->scalarNode('create_view')->end()
                        ->scalarNode('create_type')->end()
                        ->scalarNode('create_success_redirect_to')->end()
                        ->scalarNode('import_is_granted')->end()
                        ->scalarNode('import_view')->end()
                        ->scalarNode('import_type')->end()
                        ->scalarNode('import_success_redirect_to')->end()
                        ->scalarNode('version_import_is_granted')->end()
                        ->scalarNode('version_import_view')->end()
                        ->scalarNode('version_import_type')->end()
                        ->scalarNode('version_import_success_redirect_to')->end()
                        ->scalarNode('read_is_granted')->end()
                        ->scalarNode('read_view')->end()
                        ->scalarNode('preview_is_granted')->end()
                        ->scalarNode('preview_view')->end()
                        ->scalarNode('versions_is_granted')->end()
                        ->scalarNode('versions_view')->end()
                        ->scalarNode('cleanup_versions_is_granted')->end()
                        ->scalarNode('keep_version_is_granted')->end()
                        ->scalarNode('export_version_is_granted')->end()
                        ->scalarNode('update_is_granted')->end()
                        ->scalarNode('update_view')->end()
                        ->scalarNode('update_type')->end()
                        ->scalarNode('update_success_redirect_to')->end()
                        ->scalarNode('delete_is_granted')->end()
                        ->scalarNode('delete_view')->end()
                        ->scalarNode('delete_type')->end()
                        ->scalarNode('delete_success_redirect_to')->end()
                        ->scalarNode('seo_is_granted')->end()
                        ->scalarNode('seo_view')->end()
                        ->scalarNode('seo_type')->end()
                        ->scalarNode('seo_success_redirect_to')->end()
                        ->scalarNode('content_is_granted')->end()
                        ->scalarNode('content_view')->end()
                        ->scalarNode('content_type')->end()
                        ->scalarNode('content_success_redirect_to')->end()
                        ->scalarNode('publish_version_is_granted')->end()
                        ->scalarNode('unpublish_is_granted')->end()
