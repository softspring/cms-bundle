...
final class Version20230301000000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        if ($this->connection->getDatabasePlatform() instanceof PostgreSQLPlatform) {
            $this->addSql('CREATE TABLE cms_block (id CHAR(36) NOT NULL, name VARCHAR(100) NOT NULL, type VARCHAR(100) NOT NULL, data JSON DEFAULT NULL, PRIMARY KEY(id))');
            $this->addSql('CREATE UNIQUE INDEX UNIQ_AD680C0E5E237E06 ON cms_block (name)');
            $this->addSql('CREATE TABLE cms_content (id CHAR(36) NOT NULL, published_version_id CHAR(36) DEFAULT NULL, name VARCHAR(255) NOT NULL, extra_data JSON DEFAULT NULL, seo JSON DEFAULT NULL, discr VARCHAR(30) NOT NULL, PRIMARY KEY(id))');
            ...
            $this->addSql('CREATE TABLE cms_menu_item (id CHAR(36) NOT NULL, menu_id CHAR(36) DEFAULT NULL, parent_item_id CHAR(36) DEFAULT NULL, route_id VARCHAR(255) DEFAULT NULL, item_type SMALLINT NOT NULL, item_text JSON NOT NULL, options JSON DEFAULT NULL, PRIMARY KEY(id))');
            $this->addSql('CREATE INDEX IDX_1432B53DCCD7E912 ON cms_menu_item (menu_id)');
            $this->addSql('CREATE INDEX IDX_1432B53D60272618 ON cms_menu_item (parent_item_id)');
            $this->addSql('CREATE INDEX IDX_1432B53D34ECB4E6 ON cms_menu_item (route_id)');
            $this->addSql('CREATE TABLE cms_route (id VARCHAR(255) NOT NULL, content_id CHAR(36) DEFAULT NULL, route_type SMALLINT NOT NULL, redirect_type SMALLINT DEFAULT NULL, redirect_url TEXT DEFAULT NULL, symfony_route VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
            $this->addSql('CREATE INDEX IDX_2CB7BB5584A0A3ED ON cms_route (content_id)');
            $this->addSql('CREATE TABLE cms_route_path (id CHAR(36) NOT NULL, route_id VARCHAR(255) DEFAULT NULL, path CHAR(100) NOT NULL, cache_ttl INTEGER DEFAULT NULL, locale CHAR(5) DEFAULT NULL, PRIMARY KEY(id))');
            $this->addSql('CREATE UNIQUE INDEX UNIQ_95D1F10FB548B0F ON cms_route_path (path)');
            $this->addSql('CREATE INDEX IDX_95D1F10F34ECB4E6 ON cms_route_path (route_id)');
            ...
            $this->addSql('DROP INDEX UNIQ_95D1F10FB548B0F');
            $this->addSql('ALTER TABLE cms_content_version ADD version_number INTEGER DEFAULT NULL');
            $this->addSql('ALTER TABLE cms_content ADD version_number INTEGER DEFAULT NULL');
            $this->addSql('ALTER TABLE cms_content RENAME COLUMN version_number TO last_version_number');
            $this->addSql('ALTER TABLE cms_content_version ADD origin SMALLINT DEFAULT NULL');
            $this->addSql('ALTER TABLE cms_menu_item DROP CONSTRAINT FK_1432B53D34ECB4E6');
            $this->addSql('DROP INDEX IDX_1432B53D34ECB4E6');
            $this->addSql('ALTER TABLE cms_menu_item ADD symfony_route JSON DEFAULT NULL');
            $this->addSql('ALTER TABLE cms_menu_item DROP COLUMN route_id');
            $this->addSql('ALTER TABLE cms_route ALTER COLUMN symfony_route DROP DEFAULT');
            $this->addSql('ALTER TABLE cms_route ALTER COLUMN symfony_route TYPE JSON USING to_json(symfony_route)');
            $this->addSql('ALTER TABLE cms_block ADD publish_start_date INTEGER DEFAULT NULL');
            $this->addSql('ALTER TABLE cms_block ADD publish_end_date INTEGER DEFAULT NULL');
