...
class SfsCmsEvents
{
    ...
    // CONTENT VERSION TRANSLATIONS, ALL OF THEM ARE INTERNAL
    public const ADMIN_CONTENT_VERSIONS_TRANSLATIONS_INITIALIZE = 'sfs_cms.admin.content_versions.translations_initialize';
    public const ADMIN_CONTENT_VERSIONS_TRANSLATIONS_ENTITY = 'sfs_cms.admin.content_versions.translations_create_entity';
    public const ADMIN_CONTENT_VERSIONS_TRANSLATIONS_FORM_PREPARE = 'sfs_cms.admin.content_versions.translations_form_prepare';
    public const ADMIN_CONTENT_VERSIONS_TRANSLATIONS_FORM_INIT = 'sfs_cms.admin.content_versions.translations_form_init';
    public const ADMIN_CONTENT_VERSIONS_TRANSLATIONS_FORM_VALID = 'sfs_cms.admin.content_versions.translations_form_valid';
    public const ADMIN_CONTENT_VERSIONS_TRANSLATIONS_APPLY = 'sfs_cms.admin.content_versions.translations_apply';
    public const ADMIN_CONTENT_VERSIONS_TRANSLATIONS_SUCCESS = 'sfs_cms.admin.content_versions.translations_success';
    public const ADMIN_CONTENT_VERSIONS_TRANSLATIONS_FAILURE = 'sfs_cms.admin.content_versions.translations_failure';
