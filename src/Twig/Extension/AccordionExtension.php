...
class AccordionExtension extends AbstractExtension
{
    ...
    public function accordionStart(FormView $formView, string $accordionId, ?string $name = null, bool $open = false, ?string $title = null, bool $row = true, bool $alwaysope = true): string
    {
        $id = uniqid('accordion-');
